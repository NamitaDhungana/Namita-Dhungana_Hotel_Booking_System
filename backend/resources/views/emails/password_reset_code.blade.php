...
<html>
<head>
    <title>Password Reset - StayHub</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We received a request to reset your password. Use the 6-digit code below to proceed. This code expires in <strong>10 minutes</strong>.</p>
            <div class="code-box">
                <span>{{ $code }}</span>
            </div>
