...
<html>
<head>
    <title>Booking Cancelled – StayHub</title>
    <style>
        ...
        .badge { display: inline-block; background: #ffe0e0; color: #e53e3e; padding: 6px 18px; border-radius: 20px; font-size: 14px; font-weight: 700; margin-bottom: 16px; }
        ...
        .booking-details strong { color: #2D1B69; display: inline-block; width: 160px; }
        .notice { background: #fff5f5; border-left: 4px solid #e53e3e; padding: 12px 16px; border-radius: 4px; margin: 16px 0; font-size: 15px; color: #c53030; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="booking-details">
                ...
                <p><strong>Cancelled On:</strong> {{ \Carbon\Carbon::parse($booking->cancelled_at)->format('D, d M Y h:i A') }}</p>
            ...
            <div style="text-align: center;">
                <a href="{{ env('FRONTEND_URL', 'http://localhost:5173') }}/hotels" class="btn">Browse Hotels</a>
            </div>
        </div>
        <div class="footer">
